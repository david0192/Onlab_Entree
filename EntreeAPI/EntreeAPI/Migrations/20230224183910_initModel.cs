        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GroupClasses_SportFacilities_SportFacilityId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Trainers_SportFacilities_SportFacilityId",
                        column: x => x.SportFacilityId,
                        principalTable: "SportFacilities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupClassDates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GroupClassDates_GroupClasses_GroupClassId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrainerDates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TrainerDates_Trainers_TrainerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupClassDates_GroupClassId",
                table: "GroupClassDates",
                column: "GroupClassId");

            migrationBuilder.CreateIndex(
                name: "IX_GroupClasses_SportFacilityId",
                table: "GroupClasses",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrainerDates_TrainerId",
                table: "TrainerDates",
                column: "TrainerId");

            migrationBuilder.CreateIndex(
                name: "IX_Trainers_SportFacilityId",
                table: "Trainers",
                column: "SportFacilityId");
